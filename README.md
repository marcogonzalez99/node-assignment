...
# ID that returns no matches - https://node-assignment-1.glitch.me/api/movies/1
...
# TMDB that returns no matches - https://node-assignment-1.glitch.me/api/movies/tmdb/421
...
# Average rating that returns matches - https://node-assignment-1.glitch.me/api/movies/ratings/5/7
